...
config :jira_tracker,
  ecto_repos: [JiraTracker.Repo]

# Configures the endpoint
config :jira_tracker, JiraTrackerWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: JiraTrackerWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :jira_tracker, JiraTracker.Mailer, adapter: Swoosh.Adapters.Local
